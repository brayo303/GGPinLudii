public class Configuration {
    ...
    static int argsNumSelfPlay = 2;
    static int argsHistoryIter = 10;
    static int argsEvalCompetition = 20;
    static int argsEpoch = 10;
    static int argsDepthOrFilterNum = 216;
    static String path = "D:\\EDir\\finaltest";
    ...
    static String gameName = "Hex.lud";
    //static String option = "";
    static String option = "Board Size/4x4,Swap Rules/Off,End Rules/Standard";
    //static String option = "";
